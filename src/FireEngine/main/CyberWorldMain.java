...
public class CyberWorldMain {
	...
	private static void setUp() throws Exception {
		MyLogger.log(Level.INFO, "CyberWorldMain: Bootstrapping FireEngine!");
	...
	public static void run() {
		MyLogger.log(Level.INFO, "CyberWorldMain: Starting FireEngine...");
		running = true;
	...
	private static void shutdown() {
		MyLogger.log(Level.INFO, "CyberWorldMain: Starting FireEngine shutdown.");
		shutdownClientIO();
		// TODO Save persistent classes
		cleanUp();
		MyLogger.log(Level.INFO, "CyberWorldMain: Finished FireEngine shutdown.");
	}
