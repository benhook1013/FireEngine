...
import cyber_world.gameworld.maps.Exceptions.Map_Exception_Map_Load;
...
import cyber_world.gameworld.maps.Exceptions.Map_Exception_Room_Load;
...
public class Gameworld {
	...
	public static void setupGameworld() throws CheckedHibernateException, Map_Exception_Map_Load {
		...
		if (mainMap == null) {
			...
			try {
				GameMap.createMap("Default GameMap");
